...
public class StremTest14 {
    ...
    public static void main(String[] args) {
        Map<Category, Optional<LightNovel>> collect = lightNovels.stream().collect(Collectors.groupingBy(LightNovel::getCategory, Collectors.maxBy(Comparator.comparing(LightNovel::getPrice))));
